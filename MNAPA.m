...
%
% MNA Equations
%1: I_in + G1(V1-V2) + Cd(V1-V2)/dt = 0 ==> I_in + G1(V1-V2) + jwC(V1-V2) = 0
%2: G1(V2-V1) + Cd(V2-V1)/dt + G2V2 + I_L = 0 ==> G1(V2-V1) + jwC(V2-V1) + G2V2 + I_L = 0
%3: -I_L + I3 = 0
%4: -I + G4(V4-Vo) = 0
%5: G4(Vo - V4) + GoVo = 0
%6: V1 = Vin
%7: V4 - alpha*I3 = 0
%8: V2 - R3I3 - L dIL/dt = 0 ==> V2 - R3I3 - jwL*I_L = 0
%
